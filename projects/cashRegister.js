...
const checkCashRegister = (price, cash, cid) => {
  // Change is equal to payment minus purchase price
  // Multiplied by 100 (converted to pennies) to avoid JavaScript decimal calculation error
  ...
  for (let element of cid) {
    // console.log(element);
    // Only add each value at index position 1
